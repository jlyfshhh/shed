...
const resourceDefs: ResourceDef[] = [
  {
    ...
    fields: [
      ...
      { key: "location", column: "location", label: "Room / location", type: "text", required: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "details", column: "details", label: "Details", type: "text", required: true, help: "Short note shown on the task, e.g. “Every 2 weeks”" },
