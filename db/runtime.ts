...
export async function ensureDatabase(targetDate?: string) {
  ...
  await db.batch([
    ...
    db.prepare("CREATE INDEX IF NOT EXISTS animals_active_name_idx ON animals(active, name)"),
    ...
    db.prepare("CREATE TABLE IF NOT EXISTS husbandry_events (id TEXT PRIMARY KEY, task_id TEXT, animal_id TEXT NOT NULL, task_type TEXT NOT NULL DEFAULT 'general', title TEXT NOT NULL, notes TEXT, due_date TEXT, occurred_at TEXT NOT NULL, actor_role TEXT NOT NULL, completed_by_member_id TEXT, completed_by_name TEXT, voided_at TEXT, voided_by_member_id TEXT, voided_by_name TEXT, void_reason TEXT, edited_at TEXT, edited_by_member_id TEXT, edited_by_name TEXT)"),
